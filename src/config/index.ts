...
const development = {
  ...
  databaseURI:
    // 'mongodb+srv://ayaan:Password1234@cluster0.qlwc9fr.mongodb.net/testdbuser',
    `mongodb+srv://${process.env.MONGOOSE_URI_USERNAME}:${process.env.MONGOOSE_URI_PASSWORD}@${process.env.MONGO_URI}/${process.env.DEV_MONGOOSE_URI_DB}?retryWrites=true`,
